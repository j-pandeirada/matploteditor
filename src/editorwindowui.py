...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.titleFontMenu.setGeometry(QtCore.QRect(10, 60, 214, 24))
        self.titleFontMenu.setObjectName("titleFontMenu")
        self.titleFontSize = QtWidgets.QSpinBox(self.titleTab)
        self.titleFontSize.setGeometry(QtCore.QRect(230, 60, 46, 26))
        ...
        self.colorTextBox.setGeometry(QtCore.QRect(330, 60, 61, 21))
        self.colorTextBox.setObjectName("colorTextBox")
        self.label_2 = QtWidgets.QLabel(self.titleTab)
        self.label_2.setGeometry(QtCore.QRect(290, 60, 58, 16))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.titleTab)
        self.label_3.setGeometry(QtCore.QRect(10, 100, 58, 16))
        self.label_3.setObjectName("label_3")
        self.fontStyleMenu = QtWidgets.QComboBox(self.titleTab)
        self.fontStyleMenu.setGeometry(QtCore.QRect(50, 100, 76, 24))
        ...
        self.fontWeightMenu.setGeometry(QtCore.QRect(190, 100, 76, 24))
        ...
        self.label_4.setGeometry(QtCore.QRect(140, 100, 58, 16))
        ...
        self.borderColorTextBox.setGeometry(QtCore.QRect(310, 140, 61, 21))
        ...
        self.borderLineWidth.setGeometry(QtCore.QRect(240, 180, 46, 26))
        ...
        self.label_11.setGeometry(QtCore.QRect(170, 180, 71, 16))
        self.label_11.setObjectName("label_11")
        self.label_12 = QtWidgets.QLabel(self.titleTab)
        self.label_12.setGeometry(QtCore.QRect(390, 100, 71, 16))
        self.label_12.setObjectName("label_12")
        self.rotationAngle = QtWidgets.QSpinBox(self.titleTab)
        self.rotationAngle.setGeometry(QtCore.QRect(450, 100, 61, 26))
        ...
        self.titleColorPicker = QtWidgets.QToolButton(self.titleTab)
        self.titleColorPicker.setGeometry(QtCore.QRect(400, 60, 24, 26))
        self.titleColorPicker.setObjectName("titleColorPicker")
        self.bgColorPicker = QtWidgets.QToolButton(self.titleTab)
        self.bgColorPicker.setGeometry(QtCore.QRect(190, 140, 24, 26))
        self.bgColorPicker.setObjectName("bgColorPicker")
        self.borderColorPicker = QtWidgets.QToolButton(self.titleTab)
        self.borderColorPicker.setGeometry(QtCore.QRect(380, 140, 24, 26))
        self.borderColorPicker.setObjectName("borderColorPicker")
        self.titleTextBox = QtWidgets.QTextEdit(self.titleTab)
        self.titleTextBox.setGeometry(QtCore.QRect(40, 10, 231, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.titleColorPicker.setText(_translate("MainWindow", "..."))
        self.bgColorPicker.setText(_translate("MainWindow", "..."))
        self.borderColorPicker.setText(_translate("MainWindow", "..."))
